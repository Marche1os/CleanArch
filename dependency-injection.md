В рамках задачи по реализации программы в стиле ООП уже изначально использовал завязку на интерфейсы. 
Реализация создавалась в корневой функции main, но сейчас модно использовать различные решения для внедрения зависимостей,
где в отдельном компоненте задаются реализации интерфейсов.
